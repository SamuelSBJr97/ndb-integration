...
namespace Crawler.Ndb.Integration.Web.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class RestManagersController : ControllerBase
    {
        private readonly CrawlerNdbIntegrationWebContext _context;

        public RestManagersController(CrawlerNdbIntegrationWebContext context)
        {
            _context = context;
        }
